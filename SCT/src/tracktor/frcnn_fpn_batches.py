...
class FRCNN_FPN(FasterRCNN):
    ...
    def __init__(self, num_classes, box_nms_thresh=0.5, backbone_type='ResNet50FPN', class_id=None):
        ...
        self.preprocessed_image_sizes = None
        self.features = None
    ...
    def detect_batches(self, images):
        ...
        #transform to network input size
    ...
    def predict_boxes(self, boxes, class_id=None, features=None):
        assert features is not None, 'backbone features for a frame should not be None to predict the boxes'
