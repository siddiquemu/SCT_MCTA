...
if __name__ == '__main__':
    ...
    database = '/media/siddique/464a1d5c-f3c4-46f5-9dbb-bf729e5df6d6/tracking_wo_bnw/data/'
    model_path = '/media/siddique/464a1d5c-f3c4-46f5-9dbb-bf729e5df6d6/PANet_models'
    ...
    if data_type=='gt':
        ...
        if data == 'clasp2_2021':
            ...
            savefilename = imgResultDir + '/clasp2_gt_aug_det.json'
        if data == 'clasp1_2021':
            #savefilename = imgResultDir + '/clasp1_gt_det.json'
            savefilename = imgResultDir + '/clasp1_gt_aug_det.json'
        if data == 'PVD':
