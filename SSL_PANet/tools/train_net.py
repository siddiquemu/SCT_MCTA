...
def main():
    ...
    if args.load_ckpt:
        ...
        net_utils.load_ckpt(maskRCNN, checkpoint['model'],isTrain=True,FreezeResnetConv=False)
    ...
    # TODO: Since ResNeXt101_PANet is not available, we will load detectron ResNeXt101 to finetune on Clasp2
    ...
    if not args.no_save:
        ...
        # TODO: install tensorboardX to visualize the training performance
        if args.use_tfboard:
            from tensorboardX import SummaryWriter
            # Set the Tensorboard logger
            print('Initialize the summary writer.......')
