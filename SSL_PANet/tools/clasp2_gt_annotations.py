...
if __name__ == '__main__':
    ...
    isTrain = False
    # required inputs
    data = 'clasp1_2021'  # 'coco'#'clasp1_2021' #'coco'#  # 'clasp1_2021' #'clasp1_2021' #'clasp1_2021' #'coco' #'clasp2020' #
    ...
    if data == 'coco':
        ...
        load_ckpt = model_path + '/clasp2/modified_loss_semi/iter7/ckpt/model_step19999.pth'  # 'e2e_panet_R-50-FPN_2x_mask/panet_box_mask_tuned3k/ckpt/model_step9999.pth'
        class_list = [1, 2]
    ...
    data_type = 'clasp2_gt'  # 'clasp2_augMS'  # 'gt' #'test_aug
    ...
    benchmark_path = '/media/siddique/464a1d5c-f3c4-46f5-9dbb-bf729e5df6d61/tracking_wo_bnw/data/CLASP/train_gt_all/PB_gt/'
