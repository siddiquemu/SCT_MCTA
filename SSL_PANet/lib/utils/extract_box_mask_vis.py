...
def vis_one_image(
    ...
    if boxes is None or boxes.shape[0] == 0 or max(boxes[:, 4]) < thresh and out_when_no_box:
        return
    ...
    for i in sorted_inds:
        ...
        #print(output_name)
    fig.savefig(os.path.join('/media/siddique/RemoteServer/LabFiles/CLASP2/2019_10_24/exp1/Results/cam02exp1.mp4/panet', '{}'.format(im_name)), dpi=dpi)
    plt.close('all')
