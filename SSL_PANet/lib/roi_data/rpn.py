...
def add_rpn_blobs(blobs, im_scales, roidb):
    ...
    for im_i, entry in enumerate(roidb):
        #import pdb
        #pdb.set_trace()
        #print('instance certainty in single_db: {}'.format(entry['instance_certainty']))
        #print('box_to_gt_ind_map single_db: {}'.format(entry['box_to_gt_ind_map']))
    ...
    valid_keys = [
        ...
        'gt_overlaps', 'is_crowd', 'box_to_gt_ind_map', 'instance_certainty', 'gt_keypoints'
    ]
    ...
    #print('box to gt map: {}'.format(minimal_roidb[0]['box_to_gt_ind_map'].shape))
    #print('instance certainty: {}'.format(minimal_roidb[0]['instance_certainty'].shape))
