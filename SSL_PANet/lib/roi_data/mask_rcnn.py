...
def add_mask_rcnn_blobs(blobs, sampled_boxes, roidb, im_scale, batch_idx, sampled_certainties):
    ...
    if fg_inds.shape[0] > 0:
        ...
        rois_fg_certainties = sampled_certainties[fg_inds]
        ...
        rois_fg_certainties = sampled_certainties[bg_inds[0]]
    ...
    blobs['mask_rois_certainty'] = rois_fg_certainties
