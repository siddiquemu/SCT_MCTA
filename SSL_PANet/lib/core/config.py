...
# IoU >= this threshold)
__C.TEST.NMS = 0.5 # for flower use higher nms threshold: 0.7 or 0.8
...
#__C.RPN.ASPECT_RATIOS = (0.25, 0.5, 0.75, 1, 2, 2.5, 3.0)
...
#__C.FPN.RPN_ASPECT_RATIOS = (0.25, 0.5, 0.75, 1, 2.5, 3.0)
