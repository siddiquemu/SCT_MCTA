...
# IoU >= this threshold)
__C.TEST.NMS = 0.5 # To reduce FP use 0.2 or 0.1
...
__C.TEST.PROPOSAL_LIMIT = 4000#actual-2000
...
__C.TEST.DETECTIONS_PER_IM = 500 #actual-100

# Minimum score threshold (assuming scores in a [0, 1] range); a value chosen to
# balance obtaining high recall with not having too many low precision
# detections that will slow down inference post processing steps (like NMS)
__C.TEST.SCORE_THRESH = 0.6#0.05
...
__C.TEST.BBOX_VOTE.ENABLED = True #False
...
__C.RETINANET.ASPECT_RATIOS = (0.25, 0.5, 0.75, 1.0, 2.0, 2.5, 3) #(0.5, 1.0, 2.0)
...
__C.RPN.SIZES = (8, 16, 32, 64, 128, 256, 512) #(64, 128, 256, 512)
...
'''
# RPN anchor aspect ratios : Siddique>the ratio of width to height
__C.RPN.ASPECT_RATIOS = (0.25, 0.5, 0.75, 1, 2, 2.5, 3.0) #(0.5, 1, 2)
...
__C.FPN.RPN_ASPECT_RATIOS = (0.25, 0.5, 0.75, 1, 2.5, 3.0) #(0.5, 1, 2)
...
__C.FPN.RPN_ANCHOR_START_SIZE = 8 #32
