...
def vis_overlapped_trklt(final_tracklet1,final_tracklet2,i,j,out_dir):
    ...
    import matplotlib.pyplot as plt
    Dh = max(directed_hausdorff(final_tracklet1[:, 1:3], final_tracklet2[:, 1:3])[0],
            ...
            if i != j and i < params['trkltFamilySizeP'] and j >= params['trkltFamilySizeP'] \
               ...
               # else:
                ...
                if len(common_t_stamps)>60:
                    ...
                    if cam2cam=='H13to11':# and i==11 and j==13:
...
def dafault_params(cam2cam, experiment, cams, mhtTrackers, tracker_motion=False):
    if cam2cam == 'H9to2':
        ...
        param['d_th'] = 0.5#  #multi-task cost: 0.4, only loc: 0.25

        if tracker_motion:
            param['primary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam02exp1.mp4testTracks.txt'
            param['auxiliary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam09exp1.mp4testTracks.txt'
        else:
            param['primary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam02exp1.mp4.txt'
            param['auxiliary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam09exp1.mp4.txt'
    ...
    if cam2cam == 'H5to2':
        ...
        param['Aid'] = 5
        # C5: aux, C2: pri
        param['tOffsetPstart'] = -2  # 2 will start at 40 wrt 9 is 1: exp1-test: 46, exp1-train: 40, exp2-train:21
        ...
        param['fr_offsetPVis'] = 2  ## cam2 delay
        param['H'] = np.transpose(param['H'])
        param['H'] = np.linalg.inv(param['H'])
        param['d_th'] = 0.2  #multi-task cost: 0.4, only loc: 0.2,
        if tracker_motion:
            param['primary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam02exp1.mp4testTracks.txt'
            param['auxiliary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam05exp1.mp4testTracks.txt'
        else:
            param['primary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam02exp1.mp4.txt'
            param['auxiliary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam05exp1.mp4.txt'
   ...
   23.8510  508.6742    1.0000'''
        ...
        if param['Pid'] == 5:
            param['H'] = np.linalg.inv(param['H'])
        param['d_th'] = 0.31  # multi-task cost: 0.45, only loc: 0.17
        if tracker_motion:
            param['primary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam05exp1.mp4testTracks.txt'
            param['auxiliary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam11exp1.mp4testTracks.txt'
        else:
            param['primary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam05exp1.mp4.txt'
            param['auxiliary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam11exp1.mp4.txt'
  ...
  789.2232  539.3645    1.0000
   ...
   -1.0191    0.0383    0.0010
        ...
        if tracker_motion:
            param['primary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam13exp1.mp4testTracks.txt'
            param['auxiliary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam11exp1.mp4testTracks.txt'
        else:
            param['primary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam11exp1.mp4.txt'
            param['auxiliary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam13exp1.mp4.txt'
        param['finalTrackFile'] = 'cam13exp2_MCTA.txt'
        # param['finalTrackFileC2'] = 'cam02exp2_MCTA.txt'
        param['PImgsPath'] = benchmark + experiment + '/imgs/cam{:02d}'.format(cams[
  ...
  617.0456  -13.7563    1.0000'''
        ...
        if tracker_motion:
            param['primary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam13exp1.mp4testTracks.txt'
            param['auxiliary'] = '/home/siddique/Desktop/NEU_Data/May_Demo_Trackers/exp1-test/cam14exp1.mp4testTracks.txt'
        else:
            param['primary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam13exp1.mp4.txt'
            param['auxiliary'] = benchmark + 'exp1/Results/exp1_tracks_tracktor/cam14exp1.mp4.txt'
        ...
        # benchmark + experiment + '/imgs/cam{:02d}'.format(cams['C2']) + tracklet_exp + '.mp4/'
        param['AImgsPath'] = benchmark + experiment + '/imgs/cam{:02d}'.format(cams[
                                                                               'C14']) + experiment + '.mp4/'  # benchmark + 'test_data/exp1'+ '/imgs/cam{:02d}'.format(cams['C9']) + 'exp1' + '.mp4/'
        # benchmark + experiment + '/imgs/cam{:02d}'.format(cams['C9']) + tracklet_exp + '.mp4/'
...
if __name__ == "__main__":
    dataset = 'clasp2'
    benchmark = '/media/siddique/RemoteServer/LabFiles/CLASP2/2019_10_24/test_data/'
