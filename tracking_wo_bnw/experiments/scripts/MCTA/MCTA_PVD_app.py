...
class MCTA(object):
                ...
                if self.batch_start <= bb[i, 0] <= fr:
                    if bb[i, 0] == fr:
                        ...
                        if bb[i, 0] in self.meta_data['Frame'] and bb[i,-1] in self.meta_data['cam'] \
                                and self.use_metadata and int(bb[i,-1]) not in [360, 330]:
                            ...
                            if matched_label is not None:
                                ...
                                self.raw_meta_map[c] = matched_label
    ...
    def get_cam2cam_matches(self, params, cam2cam):
        ...
        if len(trackersP.keys())!=0:
            ...
            if params['Pid'] in [360] and params['Aid'] in [330] and cam2cam=='C330C360':
