...
sys.path.insert(0, '/media/siddique/464a1d5c-f3c4-46f5-9dbb-bf729e5df6d61/tracking_wo_bnw/src')
...
def my_main(_config, reid):
    ...
    state_dict = torch.load(output_dir.split(reid['name'])[0]+'/train_gt_pvd/ResNet_iter_25000.pth')
    network.load_pretrained_dict(state_dict)
    network.train()
    network.cuda()
